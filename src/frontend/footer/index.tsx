...
export default function Footer() {
  return (
    <div className='footer-container'>
      ...
      <footer className="container py-5 footer-container">
        <div className="row">
          <div className="col-6 col-md-2 mb-3">
            <h5>Section</h5>
            <ul className="nav flex-column">
              <li className="nav-item mb-2"><a href="#" className="nav-link p-0 link-secondary ">Home</a></li>
              <li className="nav-item mb-2"><a href="#" className="nav-link p-0 link-secondary ">Features</a></li>
              <li className="nav-item mb-2"><a href="#" className="nav-link p-0 link-secondary ">Pricing</a></li>
              <li className="nav-item mb-2"><a href="#" className="nav-link p-0 link-secondary ">FAQs</a></li>
          ...
          <div className="col-md-5 offset-md-1 mb-3">
            <form>
              ...
              <p className='text-secondary'>Monthly digest of whats new and exciting from us.</p>
